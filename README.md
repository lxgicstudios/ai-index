...
![npm](https://img.shields.io/npm/v/ai-index)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-index)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Search index generation and optimization tools

Project index generator. Creates main entry points with proper exports and documentation.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-index.svg)](https://badge.fury.io/js/ai-index)
